...
<section class="docs-workspace-root emsp-page-shell emsp-native-screen is-panel-collapsed" data-docs-workspace data-page="favorites">
    <div class="emsp-container">
        <header class="docs-workspace-hero emsp-editorial-bg">
            <h1 class="docs-workspace-hero-title">Mes favoris</h1>
            <p class="docs-workspace-hero-lead">Retrouvez les documents que vous avez mis de côté.</p>
        </header>

        <div class="docs-workspace-toolbar">
            <div class="docs-workspace-search">
                <i class="bi bi-search"></i>
                <input type="search" data-filter-control="query" placeholder="Rechercher dans vos favoris...">
            </div>
            <button type="button" class="docs-workspace-filter-btn" data-action="toggle-filters">Filtres</button>
        </div>
        ...
        <div class="docs-workspace-layout">
            <div class="docs-workspace-content">
                <div class="docs-workspace-resultsbar">
                    ...
                    <div class="docs-workspace-view-switch">
                        <button type="button" class="docs-workspace-view-btn is-active" data-view-mode="editorial" title="Liste">
                            <i class="bi bi-list-ul"></i>
                        </button>
                        <button type="button" class="docs-workspace-view-btn" data-view-mode="grid" title="Grille">
                ...
                <div class="docs-workspace-canvas">
                    <div class="docs-workspace-empty" data-role="empty-state" hidden>
                        <h3 data-role="empty-title">Aucun favori trouvé</h3>
                        <p data-role="empty-text">Parcourez la bibliothèque pour ajouter des documents à vos favoris.</p>
                        <a href="<?= url('documents') ?>" class="emsp-btn emsp-btn-outline btn-sm mt-2">Parcourir la bibliothèque</a>
                    </div>
            ...
            <aside class="docs-workspace-panel" data-role="filters-panel">
                ...
                <button type="button" class="emsp-btn emsp-btn-outline btn-sm w-100" data-action="reset-filters">Tout effacer</button>
            </aside>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content border-0">
                <div class="modal-header border-bottom">
                    <div>
                        <h5 class="modal-title font-heading fw-bold" data-role="quickview-title">Aperçu rapide</h5>
